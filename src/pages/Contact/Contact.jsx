...
const Contact = () => {
    ...
    return (
        <div className=" ">
            <div  data-aos="flip-left" className="text-3xl font-bold text-center my-5 bg-red-200 p-14 lg:rounded-3xl">
                Contact Us
            </div>
            <div className="hero min-h-screen  lg:mt-[-100px]">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className="text-center lg:text-left">
                        <ul className="menu ">
                            ...
                            <li>
                                ...
                                <div>
                                    <p className='text-2xl font-bold'>Social Network</p>
                                </div>

                            </li>
                            <div className=" lg:mr-36 ml-3 flex grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                    ...
                    <form onSubmit={handleSubmit} className="card lg:mr-[200px] flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
